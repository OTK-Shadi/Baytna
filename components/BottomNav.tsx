...
export default function BottomNav({ isLoggedIn }: { isLoggedIn: boolean }) {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-indigo-100 bg-white/95 px-3 py-2 backdrop-blur md:hidden" aria-label="التنقل الرئيسي" dir="rtl">
